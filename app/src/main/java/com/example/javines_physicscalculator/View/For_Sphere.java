...
public class For_Sphere extends AppCompatActivity implements View.OnClickListener {
    TextView txtAnswer;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnBack:startActivity(new Intent(For_Sphere.this,MainActivity.class));
        ...
        switch (view.getId()){
            case R.id.btnCal:
                ...
                answer = (txtInputR * txtInputR * txtInputR) *(Math.PI * 1.3333333);
