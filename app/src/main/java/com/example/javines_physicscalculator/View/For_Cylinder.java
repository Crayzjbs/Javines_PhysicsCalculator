...
public class For_Cylinder extends AppCompatActivity implements View.OnClickListener {
    TextView txtAnswer;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnBack:startActivity(new Intent(For_Cylinder.this,MainActivity.class));
        ...
        switch (view.getId()) {
            case R.id.btnCal:
                ...
                answer = ((txtInputR * txtInputR) * txtInputH) * Math.PI;
